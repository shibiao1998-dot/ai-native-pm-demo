/* ============================================================
   批 8 · AI 员工后台管理 — 数据层
   对官网平台内置的全部 AI 员工做统一管理：
   身份与专业化定位 · 技能库（每个技能 = 一套提示词与逻辑）·
   版本与进化日志。renamed：以角色 / 职能命名，环节清晰。
   ============================================================ */
...
/* ============================================================
   ...
   每个 skill：intro / contract / logic / prompt / curVer / versions / evolution
   未完整给出的字段由 enrichSkill 兜底，保证点开即用。
   ============================================================ */
const STAFF = [
  {
